 ...
 <body>
    <header>
        <div class="header-content">
           <img src=/storage/8602-12EE/Documents/Ananthi.jpg alt ="your profile picture" class ="profile-picture">
           <h3>k.Ananthi</h3>
           <p>student</p>
        </div>
    </header>
    ...
    <div class="section-content">
        <h2>about me</h2>   
        <p>hello everyone! this is ananthi and i am a bsc student</p>
    </div>
    </section>
